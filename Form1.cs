...
namespace _2dd
{
    ...
    public partial class Form1 : Form
    {
        ...
        public List <NaveAliena> alieni = new List<NaveAliena>();   
        ...
        public Form1()
        {
            ...
            alieni.Add(new NaveAliena(100, Yamericanopartenza[2], 5));
        ...
        public void AlienoSiMuove()
        {

            foreach (NaveAliena aliena in alieni)
            {

                aliena.MossaNave(aliena, proiettili);
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            foreach (NaveAliena a in alieni)
            {
                a.DisegnaNave(a.life, nuvolette[1].PosizioneY, g);
